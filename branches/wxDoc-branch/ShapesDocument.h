...
public:
	...
	ShapesColorTableList	colortables;
	ShapesSequenceList		sequences;
	ShapesFrameList			frames;
	ShapesBitmapList		bitmaps;
...
public:
	short			status;
	unsigned short	flags;
	ShapesChunk		*chunks[2];	// chunks for 8-bit and truecolor game
};
